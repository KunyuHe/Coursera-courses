...
knitr::opts_chunk$set(fig.width=13, fig.height=6.5) 
options(scipen=999)
```
...
```{r area-price-dist, fig.width=13, fig.height=14}
...
```{r post-area-price-dist, fig.width=13, fig.height=14}
...
After initial data processing, there are **`r dim[1]`** observations and **`r dim[2]`** variables left for our analysis.
...
```{r log_price-Bsmt, fig.width=9, fig.height=7}
