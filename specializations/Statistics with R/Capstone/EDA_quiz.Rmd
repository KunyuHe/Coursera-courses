...
ggplot(data=ames_train, aes(x=Overall.Qual, y=price)) + geom_jitter()
ggplot(data=ames_train, aes(x=Bedroom.AbvGr, y=price)) + geom_jitter()
ggplot(data=ames_train, aes(x=Year.Built, y=price)) + geom_jitter()
```
...
ames_no_na <- na.omit(ames_train[c("BsmtFin.Type.1", "BsmtFin.Type.2", "Bsmt.Cond", "Bsmt.Unf.SF")])
ames_no_na %>%
