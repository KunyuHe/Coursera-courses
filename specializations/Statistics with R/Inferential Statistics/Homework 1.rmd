...
ggplot(samp1, aes(x = area)) + geom_histogram(binwidth = 250)
```
...
samp_means25 <- ames %>%
  ...
  summarise(x_bar = mean(area))
ggplot(data = samp_means25, aes(x = x_bar)) +
  geom_histogram(binwidth = 20)
```
...
ggplot(sample_means50, aes(x=mu)) + geom_histogram(binwidth=1000)
```
...
sample_means150 <- ames %>%
  ...
  summarise(mu=mean(price))
ggplot(sample_means150, aes(x=mu)) + geom_histogram(binwidth=1000)
```
...
sample_means15 <- ames %>%
  ...
  summarise(mu=mean(price))
ggplot(sample_means15, aes(x=mu)) + geom_histogram(binwidth=1000)
```
