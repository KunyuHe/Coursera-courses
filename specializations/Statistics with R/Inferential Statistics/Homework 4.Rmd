...
us12 %>%
  group_by(response)%>%
  summarise(count=n())
inference(y = response, data = prc12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
spain5_12 %>%
  ...
  summarise(count=n())
inference(y = response, x= factor(year), data = spain5_12, statistic = "proportion", type = "ht", method = "theoretical", success = "atheist", null = 0, alternative = "twosided", conf_level=0.95)
```
...
us5_12 %>%
  group_by(year, response)%>%
  summarise(count=n())
inference(y = response, x= factor(year), data = us5_12, statistic = "proportion", type = "ht", method = "theoretical", success = "atheist", null = 0, alternative = "twosided", conf_level=0.95)
```
