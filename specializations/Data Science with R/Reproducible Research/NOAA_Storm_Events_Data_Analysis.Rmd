...
Download the data from the course website at **`r dateDownloaded`**. Then load the data into the working environment and make a cache.
...
Check the data. There are **`r dim_storm[1]`** observations and **`r dim_storm[2]`** variables. Choose the variables relevant to our analysis according to the [codebook](https://d396qusza40orc.cloudfront.net/repdata%2Fpeer2_doc%2Fpd01016005curr.pdf). Only 7 variables are selected, which include:
